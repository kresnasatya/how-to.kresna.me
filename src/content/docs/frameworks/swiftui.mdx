...
I have tell you that I have been programming Swift with Swift Playgrounds in [Swift Programming section](/programming/swift). The experience is great! Now, I'm seeking learning resources to how to develop app with Swift and SwiftUI.
Fortunately I found it from Apple Developer Documentation site.
